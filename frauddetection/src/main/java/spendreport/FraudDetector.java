...
public class FraudDetector extends KeyedProcessFunction<Long, Transaction, Alert> {
    ...
    private static final double SMALL_AMOUNT = 100.00;
    ...
    public void open(Configuration parameters) {
        ValueStateDescriptor<Boolean> stateDescriptor = new ValueStateDescriptor<Boolean>("flag", Types.BOOLEAN);
        flagState = getRuntimeContext().getState(stateDescriptor);

        ValueStateDescriptor<Long> timeDescriptor = new ValueStateDescriptor<Long>("timer", Types.LONG);
